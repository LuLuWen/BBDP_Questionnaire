...
public class PatientQuestionnaireServer {
	...
	public static ArrayList searchPatientQuestionnaireType(Connection conn, String doctorID, String patientID) {
	...
	public static ArrayList selectQuestionnaire(Connection conn, String doctorID, String patientID, String patientSelect) {
		ArrayList typeList = new ArrayList();
		String sql = "";
	...
	public static ArrayList unfilledquestionnaire(Connection conn, String doctorID, String patientID) {
		ArrayList typeList = new ArrayList();
		try {
			Statement st = conn.createStatement();
	...
	public static ArrayList selectQuestionnaireDate(Connection conn, String doctorID, String patientID, String patientSelect, String type, String dateRange) {
	...
	public static ArrayList getQuestionnaireList(Connection conn, String doctorID, String patientID, String patientSelect, String type, String dateRange, String date){
		String searchTemp="";
	...
	public static ArrayList getUnfilledQuestionnaire(Connection conn, String doctorID, String patientID, String unfilledID){
		ArrayList questionnaireList = new ArrayList();
		try {
			Statement st = conn.createStatement();
			ResultSet rs = st.executeQuery("select * FROM unfilledquestionnaire natural join questionnaire where doctorID='"+doctorID+"' and patientID = '"+patientID+"' and unfilledID = '"+unfilledID+"'");
	...
	public static int cancelQuestionnaire(Connection conn, String patientID, String unfilledID) {
		int returnInt = 0;
		SimpleDateFormat sdfDay = new SimpleDateFormat("yyyy-MM-dd");
		DateFormat sdfDayTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Calendar now = Calendar.getInstance();
	...
	public static ArrayList getQuestionnaireAnswer(Connection conn, String doctorID, String patientID, String answerID){
		ArrayList questionnaireList = new ArrayList();
		try {
			Statement st = conn.createStatement();
			ResultSet rs = st.executeQuery("select * FROM answer join questionnaire where answer.questionnaireID = questionnaire.questionnaireID and questionnaire.doctorID='"+doctorID+"' and patientID = '"+patientID+"'and answerID = '"+answerID+"'");
	...
	public static ArrayList getNewestAnswer(Connection conn, String doctorID, String patientID) {
